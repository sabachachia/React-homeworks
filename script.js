...
function Card(props){
    return React.createElement("article", {className: "user_card"}, [
        React.createElement("h1", {className: "username"}, [`${props.firstname} ${props.lastname}`]),
        React.createElement("h2", {className: "user_email"}, [`email: ${props.email}`]),
        React.createElement("h3", {className: "user_gender"}, [`Gender: ${props.gender}`]),
        React.createElement("h3", {className: "user_age"}, [`Age: ${props.age}`]),
        React.createElement("h3", {className: "user_job"}, [`Job: ${props.job}`])
    ]);
}
function App(){
